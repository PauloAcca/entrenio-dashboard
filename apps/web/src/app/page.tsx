      ...
      <section className="mx-auto max-w-6xl px-4 py-8 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <a href="#" className="w-full sm:w-auto flex items-center justify-center sm:justify-start gap-3 bg-black text-white px-5 py-3 rounded-xl border border-transparent hover:border-slate-800 hover:scale-105 transition-all shadow-lg cursor-target group">
            ...
            <a href="#" className="w-full sm:w-auto flex items-center justify-center sm:justify-start gap-3 bg-white text-black px-5 py-3 rounded-xl border border-slate-200 hover:border-slate-300 hover:scale-105 transition-all shadow-lg cursor-target group">
          ...
          <div className="mt-10 flex flex-col items-start">
             <span className="inline-block py-1 px-3 rounded-full bg-slate-100 text-slate-600 text-xs font-bold mb-3 tracking-wide uppercase">Para Negocios</span>
             <h3 className="font-semibold text-slate-900 text-lg">¿Tenés un Gimnasio?</h3>
             <p className="text-slate-500 text-md mt-1 mb-4">
               Digitalizá tu sala de musculación y fidelizá a tus socios con nuestra plataforma.
             </p>
             <a href="/gimnasios" className="inline-flex items-center gap-2 text-black font-bold border-b-2 border-black pb-0.5 hover:text-slate-600 hover:border-slate-300 transition-all cursor-target w-full sm:w-auto justify-center sm:justify-start">
