      ...
      <section className="mx-auto max-w-6xl px-4 py-8 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <a href="https://apps.apple.com/ar/app/entrenio/id6755614606" className="w-full sm:w-auto flex items-center justify-center sm:justify-start gap-3 bg-black text-white dark:bg-white dark:text-black px-5 py-3 rounded-xl border border-transparent hover:border-slate-800 dark:hover:border-slate-300 hover:scale-105 transition-all shadow-lg cursor-target group">
