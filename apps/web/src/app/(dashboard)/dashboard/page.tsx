    ...
    const PLANS = {
        ...
        "plan premium": {
            ...
            "beneficios": [
                ...
                "Creación de rutinas manual",
                "Base de datos de ejercicios",
                "Seguimiento semanal y mensual de las rutinas de los socios con IA",
                "Modificacion manual de las rutinas de los socios desde el panel",
    ...
    return (
        <div className="w-full min-h-full p-6 md:p-12 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
                {gym?.logo_url && (
                    <img src={gym.logo_url} alt={gym.name} className="w-16 h-16 md:w-28 md:h-28 object-contain shrink-0" />
                )}
