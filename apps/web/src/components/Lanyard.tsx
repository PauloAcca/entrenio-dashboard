...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 w-full h-full min-h-[500px] flex justify-center items-center transform scale-100 origin-center pointer-events-auto cursor-grab active:cursor-grabbing">
      <Canvas
        camera={{ position, fov }}
