      ...
      <div className="p-4 space-y-2">
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-2">
              <DownloadButton
                ...
                icon={ImageDown}
                label="Descargar SVG"
                sublabel="Vectorial, ideal para impresión"
                variant="primary"
              />
              <DownloadButton
                onClick={() =>
        ...
        {hasSelection && (
          <>
            ...
            <div className={isMulti ? "grid grid-cols-2 gap-2" : "grid grid-cols-2 gap-2"}>
              <DownloadButton
